...
export function SermonDetail({ sermon, onClose }: SermonDetailProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      ...
      <div className="relative min-h-screen flex items-start justify-center p-4 pt-8">
        <div className="relative w-full max-w-5xl bg-white rounded-2xl shadow-2xl overflow-hidden animate-[slide-up_0.3s_ease-out]">
          {/* Close button */}
          <button
            onClick={onClose}
